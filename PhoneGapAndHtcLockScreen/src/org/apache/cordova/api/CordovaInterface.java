...
public interface CordovaInterface {
	...
	public abstract void setBound(boolean override);

	public abstract boolean getBound();

	public abstract void spinnerStop();

	public abstract void removeSplashScreen();

	public abstract PluginManager getPluginManager();

	public abstract String getBaseUrl();

	public abstract AuthenticationToken getAuthenticationToken(String host,
			String realm);

	public abstract void incrementLoadUrlTimeout();
	...
	public abstract Object peekAtUrlStack();

	public abstract int getSplashscreen();

	public abstract View getRoot();

	public abstract WebView getAppView();

	public abstract CallbackServer getCallbackServer();
